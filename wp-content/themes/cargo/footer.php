...
if ( is_active_sidebar( 'footer_widgets' ) ) {
	echo ' 
	<section class="boldSection gutter btSiteFooterCurve ' . $extra_class . '">
		<div class="port">
	...
	<section class="boldSection btSiteFooterWidgets gutter topSemiSpaced topSemiSpaced btDoubleRowPadding ' . $extra_class . '">
		<div class="port">
...
if ( $custom_text_html != '' || has_nav_menu( 'footer' )) { 
	echo '
	<footer class="boldSection gutter btSiteFooter btGutter ' . $extra_class . '">
		<div class="port">
			<div class="boldRow">
