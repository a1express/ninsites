    ...
    <div class="port">
        ...
        if ( $email != '' )
        {
...
else if ( DomainManager::IsMMCourierDomain() )
            {
                ...
                $mailBody = "<HTML><head></head><body><table width=800>";
                $mailBody .= "<tr><td valign=top><img src='http://dev.boxonabus.com/wp-content/themes/cargo/img/mm_header.png' alt='marylandmessenger.com'></td></tr>";
                $mailBody .= "<tr><td><table width='100%'><tr align=center><td valign=top><a href='http://dev.boxonabus.com/quick-quote/' title='Quick Quote'>QUICK QUOTE</a> | <a href='http://dev.boxonabus.com/new-account/' title='Order Now'>ORDER NOW</a> | <a href='http://dev.boxonabus.com/company/' title='About us'>ABOUT US</a> | <a href='http://dev.boxonabus.com/services/' title='Services'>SERVICES</a></td></tr></table></td></tr>";
                $mailBody .= "<tr align=center><td valign=top><font color=#50A21E size=8>Save Time & Gas</font></td></tr>";
                $mailBody .= "<tr align=center><td valign=top><a href='http://dev.boxonabus.com/new-account/' title='Order Now'><img src='http://dev.boxonabus.com/wp-content/themes/cargo/img/MM_Middle.png' border=0 alt='Order Now and get $5.00 off'></a></td></tr>";
