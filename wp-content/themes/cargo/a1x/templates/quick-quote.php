    ...
    <div class="port">
        ...
        if ( $email != '' )
        {
 ...
 else if ( DomainManager::IsASAPCourierDomain() )
            {
                ...
                $mailBody .= "<tr><td><table width='100%'><tr align=center><td valign=top><a href='http://dev.boxonaplane.com/quick-quote/' title='Quick Quote'>QUICK QUOTE</a> | <a href='https://asapcourierfl.com/new-account/' title='Order Now'>ORDER NOW</a> | <a href='https://asapcourierfl.com/about-us/' title='About us'>ABOUT US</a> | <a href='https://asapcourierfl.com/services/' title='Services'>SERVICES</a></td></tr></table></td></tr>";
                $mailBody .= "<tr align=center><td valign=top><font color=#50A21E size=8>Save Time & Gas</font></td></tr>";
