    ...
    <div class="port">
        ...
        if ( $email != '' )
        {
 ...
 else if ( DomainManager::IsASAPCourierDomain() )
            {
                ...
                $mailBody = "<HTML><head></head><body><table width=800>";
                $mailBody .= "<tr><td valign=top><img src='http://dev.boxonaplane.com/wp-content/themes/cargo/img/asap_Logo.png' alt='expresswaycourier.com'></td></tr>";
                $mailBody .= "<tr><td><table width='100%'><tr align=center><td valign=top><a href='http://dev.boxonaplane.com/quick-quote/' title='Quick Quote'>QUICK QUOTE</a> | <a href='http://dev.boxonaplane.com/order-now/' title='Order Now'>ORDER NOW</a> | <a href='http://dev.boxonaplane.com/about-us/' title='About us'>ABOUT US</a> | <a href='http://dev.boxonaplane.com/services/' title='Services'>SERVICES</a></td></tr></table></td></tr>";
                $mailBody .= "<tr align=center><td valign=top><font color=#50A21E size=8>Save Time & Gas</font></td></tr>";
                $mailBody .= "<tr align=center><td valign=top><a href='http://asapcourierfl.com/order-now/' title='Order Now'><img src='http://dev.boxonaplane.com/wp-content/themes/cargo/img/asap_Special.png' border=0 alt='Order Now and get $5.00 off'></a></td></tr>";
