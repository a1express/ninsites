...
<?php if ( get_queried_object_id() == 1943 || get_queried_object_id() ==  2121 ): ?>
			...
			<?php 
				...
				if ( $email != '' )
				{
					$params = "?origin=" . $origin . "&destination=" . $destination . "&pieces=" . $pieces . "&weight=" . $weight . "&date=" . $date . "&track2=" . $time . "&jumpMenu=" . $ampm . "&email=" . $email . "&jumpMenu2=" . $vehicle . "&optin=" . $foptin;
								$solve360Url = "http://www.webicise.com/Solve360/A1Express/QuickQuote/Solve360ContactSave.php" . $params;
					...
					$mailBody .= "<tr><td valign=top><img src='http://www.a1express.com/img/logo1.png' alt='A1Express.com'></td></tr>";
					$mailBody .= "<tr><td><table width='100%'><tr align=center><td valign=top><a href='http://www.a1express.com/courier/quickquote.asp' title='Quick Quote'>QUICK QUOTE</a> | <a href='http://www.a1express.com/library/services/quote/special_quote_request.asp' title='Special Quote'>SPECIAL QUOTE</a> | <a href='https://www.a1express.com/register.asp' title='Open an Account'>OPEN ACCOUNT</a> | <a href='https://www.a1express.com/order.asp' title='Order Now'>ORDER NOW</a> | <a href='http://www.a1express.com/library/aboutus/default.asp' title='About us'>ABOUT US</a> | <a href='http://www.a1express.com/courier/tracking.asp' title='Tracking'>TRACKING</a> | <a href='http://www.a1express.com/library/services/default.asp' title='Services'>SERVICES</a></td></tr></table></td></tr>";
					$mailBody .= "<tr align=center><td valign=top><font color=#50A21E size=8>Save Time & Gas</font></td></tr>";
					$mailBody .= "<tr align=center><td valign=top><a href='https://www.a1express.com/order.asp' title='Order Now'><img src='http://www.a1express.com/img/a1express.png' border=0 alt='Order Now and get $5.00 off'></a></td></tr>";
					$mailBody .= "<tr align=center><td><font color=#50A21E>You recently requested a same day courier service quote at A1Express.com.  Place an order for your<br>1st courier delivery within the next 7 days and get $5 off with the coupon code AX100.<br><br>If you place an order online; place the code in the reference field on the order form and $5.00 will be<br>deducted from the order before final charges.</font></td></tr>";
					$mailBody .= "<tr><td><table width='100%' bgcolor=#0A8C3B><tr align=center><td><font color=#FFFFFF>A1Express | 877.219.7737 | 1231 Collier Rd Ste H | Atlanta, GA | 30318</font></td valign=right><font color=#FFFFFF><strong>FOLLOW US:&nbsp;&nbsp;&nbsp;</strong></font><a href='http://www.facebook.com/a1express' title='Facebook'><img src='http://www.a1express.com/img/facebook1.png' border=0 alt='Facebook'></a>&nbsp;&nbsp;<a href='https://twitter.com/#!/A1Express1' title='Twitter'><img src='http://www.a1express.com/img/twitter1.png' border=0 alt='Twitter'></a>&nbsp;&nbsp;<a href='http://blog.a1express.com/' title='News'><img src='http://www.a1express.com/img/blogger.png' border=0 width=16 height=16 alt='News'></a><td></td></tr></table></td></tr>";
					$mailBody .= "<tr><td>If you would like to unsubscribe and stop receiving these emails <a href=mailto:lisa@a1express.com?subject=Unsubscribe%20to%20A1Express%20QuickQuotes>click here</a></td></tr>";
					$mailBody .= "</td></tr></table></body></html>";

					$headers  = 'MIME-Version: 1.0' . "\r\n";
					$headers .= 'Content-type: text/html; charset=utf-8' . "\r\n";
					$headers .= 'To: ' . $email . "\r\n";
					$headers .= 'From: Manhattan Courier Service <lisa@manhattancourierservice.com>' . "\r\n";
